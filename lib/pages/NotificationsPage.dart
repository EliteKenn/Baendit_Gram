            ...
            child: RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(text: " $notifiationItemText"),
                ],
              )
            ),
          ),
...
mediaPreview = Text("");
    ...
    if(type == "like"){
      notifiationItemText = "Liked your post.";
    }
    else if(type == "comment"){
      notifiationItemText = "Replied: $commentData.";
    }
    else if(type == "follow"){
      notifiationItemText = "started following you";
    }
    else{
      notifiationItemText = "Error. Unknown type = $type";
    }
