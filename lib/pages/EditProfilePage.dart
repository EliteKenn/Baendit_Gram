...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  updateUserData(){
    setState(() {
      profileTextEditingController.text.trim().length < 3 || profileTextEditingController.text.isEmpty ? _profileNameValid = false : _profileNameValid = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: loading ? circularProgress() : new ListView(
        children: <Widget>[
          Container(
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    children: <Widget>[createProfileNameTextField(), createBioTextFormField()],
                  ),
                ),
                Padding(
